...
export class FacebookService {
    ...
    constructor({ appId, appSecret, fields, version = "v2.11" }) {
        this.appId = appId;
    ...
    getApp() {
        return { client_id: this.appId, client_secret: this.appSecret };
    }
    ...
    async api(...args) {
        args[0] = this.cleanPath(args[0]);
        return await this.getFb().api(...args);
    }
