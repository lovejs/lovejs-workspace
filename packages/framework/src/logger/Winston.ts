...
_winston.format["emojify"] = require("./formatters/emojify");
_winston.format["stylify"] = require("./formatters/stylify");
_winston.format["errorstack"] = require("./formatters/errorstack");
_winston.transports["Notifier"] = require("./transports/NotifyTransport");
